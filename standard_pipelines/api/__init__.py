...
def hubspot_oauth_client_register(app: Flask):
    ...
    oauth.register(
        ...
        client_kwargs={
            'scope': 'crm.objects.contacts.read crm.objects.contacts.write crm.objects.deals.read crm.objects.deals.write crm.schemas.deals.read crm.schemas.deals.write oauth crm.schemas.users.read crm.schemas.users.write',
            'token_endpoint_auth_method': 'client_secret_post'
        }
    )

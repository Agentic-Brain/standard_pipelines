...
@testing.route('/credentials/hubspot', methods=['POST'])
...
@testing.route('/credentials/hubspot/<uuid:client_id>', methods=['GET'])
...
@testing.route('/credentials/fireflies', methods=['POST'])
...
@testing.route('/credentials/fireflies/<uuid:client_id>', methods=['GET'])

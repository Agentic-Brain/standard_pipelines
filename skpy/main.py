...
class Skype(SkypeObj):
    ...
    def __init__(self, user=None, pwd=None, tokenFile=None, connect=True):
        ...
        self.conn : SkypeConnection = SkypeConnection()
        if tokenFile:
        ...
        self.contacts : SkypeContacts = SkypeContacts(self)
        self.chats : SkypeChats = SkypeChats(self)
        self.settings : SkypeSettings = SkypeSettings(self)
        self.translate : SkypeTranslator = SkypeTranslator(self)
    ...
    def getEvents(self) -> list[SkypeEvent]:
        """
        ...
        """
        print(f"[{self.rand_id}] getting events")
